...
class Restorant extends MyModel
{
  ...
  {
    return $this->hasMany(Categories::class, 'company_id', 'id')->where(['categories.active' => 1])->ordered();
  }

  public function categoriesall(): HasMany
  {
    return $this->hasMany(Categories::class, 'company_id', 'id')->ordered();
  }


  public function localmenus(): HasMany
  {
    return $this->hasMany(LocalMenu::class, 'restaurant_id', 'id');
  }

  public function hours(): HasMany
  {
    return $this->hasMany(Hours::class, 'restorant_id', 'id');
  }
  ...
  {
    return $this->hasMany(User::class, 'restaurant_id', 'id')->role('staff');
  }

  public function areas(): HasMany
  {
    return $this->hasMany(RestoArea::class, 'restaurant_id', 'id');
  }

  public function deliveryareas(): HasMany
  {
    return $this->hasMany(SimpleDelivery::class, 'restaurant_id', 'id');
  }

  public function visits(): HasMany
  {
    return $this->hasMany(Visit::class, 'restaurant_id', 'id');
  }

  public function orders(): HasMany
  {
    return $this->hasMany(Order::class, 'restorant_id', 'id');
  }

  public function systemcategories(): BelongsToMany
  {
    return $this->belongsToMany(Posts::class, 'vendor_has_categories', 'vendor_id', 'category_id');
  }
